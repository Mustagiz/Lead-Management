...
import { Coffee, CheckCircle, Check, X, Filter, RefreshCw, Download, Upload, Edit, LogOut, Clock, History } from 'lucide-react';
                                        ...
                                        {paginatedLeads.map(lead => (
                                            <tr key={lead.id} className="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-sm">
                                                    <div className="flex gap-2">
                                                        <button onClick={() => { setEditingLead(lead); setShowUploadModal(true); }} className="text-blue-600 dark:text-blue-400 hover:text-blue-900 transition-colors" title="Edit">
                                                            <Edit className="w-5 h-5" />
                                                        </button>
                                                        <button onClick={() => setShowHistoryLead(lead)} title="Audit History" className="text-purple-600 dark:text-purple-400 hover:text-purple-900 transition-colors">
