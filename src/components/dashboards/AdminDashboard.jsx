            ...
            {activeTab === 'reports' && (
                <div className="space-y-6">
                    <div className="grid grid-cols-1 gap-8">
                        <Card className="p-8 h-[600px] shadow-2xl shadow-indigo-500/10">
                            <h3 className="text-xl font-black text-slate-900 dark:text-white mb-8 flex items-center font-display">
                        ...
                        <Card className="p-8 h-[600px] shadow-2xl shadow-emerald-500/10">
                            <h3 className="text-xl font-black text-slate-900 dark:text-white mb-8 flex items-center font-display">
