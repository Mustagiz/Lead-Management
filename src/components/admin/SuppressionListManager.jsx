...
const SuppressionListManager = ({ campaigns, currentUser }) => {
    ...
    const fetchList = useCallback(async () => {
        ...
        if (searchTerm) {
            query = query.ilike('identifier_value', `%${searchTerm}%`);
        }
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full">
                            ...
                            <tbody className="divide-y divide-gray-100 dark:divide-slate-800">
                                {isLoading ? (
                                    <tr><td colSpan="5" className="px-6 py-10 text-center text-gray-500">Loading identifiers...</td></tr>
                                ) : (
                                    list.map(item => (
                    ...
                    {totalPages > 1 && (
                        <div className="px-6 py-4 border-t border-gray-100 dark:border-slate-800 flex items-center justify-between bg-gray-50/30 dark:bg-slate-800/10">
                            <div className="flex flex-col">
                                ...
                                <span className="text-[10px] text-gray-400">Total Records: {totalCount}</span>
                            </div>
                            <div className="flex gap-2">
